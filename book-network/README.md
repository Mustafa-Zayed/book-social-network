...
- **Spring Boot 4**: A powerful framework for building Java-based applications.
- **Spring Security 7**: Provides authentication and authorization mechanisms for securing the application.
- **JWT Token Authentication & Keycloak**: Ensures secure communication between the client and server.
...
```bash
   git clone https://github.com/Mustafa-Zayed/book-social-network.git
```
